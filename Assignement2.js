...
<<<<<<< HEAD
    -> File Watcher Algorithm ,
         ...
         cleaning & Bundling required code together and removing dead/unUsed code using TreeShaking, 
         compressing media/node_modules/etc, 
         adding Polyfills so that this web application is compatible and can be viewed on all required platforms, 
         caching while development, 
         consistent hashing algorithm for all bundling and caching, 
         provides HTTPS on development server, 
         handles port configuration, 
         minify, 
         gives functionality to enable HTTPS on dev machine, 
         compression, 
